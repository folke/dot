...
function base16-gruvbox-dark-hard -d "base16 Gruvbox dark, hard theme"
    ...
    __base16_fish_shell_create_vimrc_background gruvbox-dark-hard
    set -U base16_fish_theme gruvbox-dark-hard
