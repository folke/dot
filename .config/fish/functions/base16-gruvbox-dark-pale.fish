...
function base16-gruvbox-dark-pale -d "base16 Gruvbox dark, pale theme"
    ...
    set color_foreground "da/b9/97" # Base 05
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg dab997 # foreground
      __put_template_custom Ph 262626 # background
      __put_template_custom Pi dab997 # bold color
      __put_template_custom Pj 4e4e4e # selection color
      __put_template_custom Pk dab997 # selected text color
      __put_template_custom Pl dab997 # cursor
    ...
    set -gx fish_color_autosuggestion "8a8a8a" brblack
    set -gx fish_pager_color_description "ff8700" yellow

    __base16_fish_shell_set_background "26" "26" "26"
    __base16_fish_shell_create_vimrc_background gruvbox-dark-pale
    set -U base16_fish_theme gruvbox-dark-pale
