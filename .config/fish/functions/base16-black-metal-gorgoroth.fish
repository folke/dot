...
function base16-black-metal-gorgoroth -d "base16 Black Metal (Gorgoroth) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-gorgoroth
    set -U base16_fish_theme black-metal-gorgoroth
