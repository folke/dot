...
function base16-default-dark -d "base16 Default Dark theme"
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pj 383838 # selection color
    ...
    set -gx fish_pager_color_description "dc9656" yellow

    __base16_fish_shell_set_background "18" "18" "18"
    __base16_fish_shell_create_vimrc_background default-dark
    set -U base16_fish_theme default-dark
