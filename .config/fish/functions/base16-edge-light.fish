...
function base16-edge-light -d "base16 Edge Light theme"
    ...
    set color_foreground "5e/64/6f" # Base 05
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg 5e646f # foreground
      __put_template_custom Ph fafafa # background
      __put_template_custom Pi 5e646f # bold color
      __put_template_custom Pj d69822 # selection color
      __put_template_custom Pk 5e646f # selected text color
      __put_template_custom Pl 5e646f # cursor
    ...
    set -gx fish_color_autosuggestion "5e646f" brblack
    set -gx fish_pager_color_description "db7070" yellow

    __base16_fish_shell_set_background "fa" "fa" "fa"
    __base16_fish_shell_create_vimrc_background edge-light
    set -U base16_fish_theme edge-light
