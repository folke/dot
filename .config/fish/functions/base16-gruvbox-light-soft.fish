...
function base16-gruvbox-light-soft -d "base16 Gruvbox light, soft theme"
    ...
    set color_background "f2/e5/bc" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Ph f2e5bc # background
      ...
      __put_template_custom Pm f2e5bc # cursor text
    ...
    set -gx fish_pager_color_description "af3a03" yellow

    __base16_fish_shell_set_background "f2" "e5" "bc"
    __base16_fish_shell_create_vimrc_background gruvbox-light-soft
    set -U base16_fish_theme gruvbox-light-soft
