...
function base16-brushtrees-dark -d "base16 Brush Trees Dark theme"
    ...
    set color_foreground "b0/c5/c8" # Base 05
    set color_background "48/58/67" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg b0c5c8 # foreground
      __put_template_custom Ph 485867 # background
      __put_template_custom Pi b0c5c8 # bold color
      __put_template_custom Pj 6d828e # selection color
      __put_template_custom Pk b0c5c8 # selected text color
      __put_template_custom Pl b0c5c8 # cursor
      __put_template_custom Pm 485867 # cursor text
    ...
    set -gx fish_color_autosuggestion "8299a1" brblack
    ...
    set -U base16_fish_theme brushtrees-dark
