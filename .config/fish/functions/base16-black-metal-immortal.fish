...
function base16-black-metal-immortal -d "base16 Black Metal (Immortal) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-immortal
    set -U base16_fish_theme black-metal-immortal
