...
function base16-black-metal-venom -d "base16 Black Metal (Venom) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-venom
    set -U base16_fish_theme black-metal-venom
