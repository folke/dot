...
function base16-chalk -d "base16 Chalk theme"
    ...
    set -gx fish_pager_color_description "eda987" yellow

    __base16_fish_shell_set_background "15" "15" "15"
    __base16_fish_shell_create_vimrc_background chalk
    set -U base16_fish_theme chalk
