...
function base16-black-metal-burzum -d "base16 Black Metal (Burzum) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-burzum
    set -U base16_fish_theme black-metal-burzum
