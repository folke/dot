...
function base16-material -d "base16 Material theme"
    ...
    set color_foreground "ee/ff/ff" # Base 05
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg eeffff # foreground
      __put_template_custom Ph 263238 # background
      __put_template_custom Pi eeffff # bold color
      __put_template_custom Pj 314549 # selection color
      __put_template_custom Pk eeffff # selected text color
      __put_template_custom Pl eeffff # cursor
    ...
    set -gx fish_color_autosuggestion "546e7a" brblack
    set -gx fish_pager_color_description "f78c6c" yellow

    __base16_fish_shell_set_background "26" "32" "38"
    __base16_fish_shell_create_vimrc_background material
    set -U base16_fish_theme material
