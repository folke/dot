...
function base16-cupertino -d "base16 Cupertino theme"
    ...
    set color_foreground "40/40/40" # Base 05
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg 404040 # foreground
      __put_template_custom Ph ffffff # background
      __put_template_custom Pi 404040 # bold color
      __put_template_custom Pj c0c0c0 # selection color
      __put_template_custom Pk 404040 # selected text color
      __put_template_custom Pl 404040 # cursor
    ...
    set -gx fish_pager_color_description "eb8500" yellow

    __base16_fish_shell_set_background "ff" "ff" "ff"
    __base16_fish_shell_create_vimrc_background cupertino
    set -U base16_fish_theme cupertino
