...
function base16-grayscale-light -d "base16 Grayscale Light theme"
    ...
    set color_foreground "46/46/46" # Base 05
    set color_background "f7/f7/f7" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg 464646 # foreground
      __put_template_custom Ph f7f7f7 # background
      __put_template_custom Pi 464646 # bold color
      __put_template_custom Pj b9b9b9 # selection color
      __put_template_custom Pk 464646 # selected text color
      __put_template_custom Pl 464646 # cursor
      __put_template_custom Pm f7f7f7 # cursor text
    ...
    set -gx fish_pager_color_description "999999" yellow

    __base16_fish_shell_set_background "f7" "f7" "f7"
    __base16_fish_shell_create_vimrc_background grayscale-light
    set -U base16_fish_theme grayscale-light
