...
function base16-black-metal-bathory -d "base16 Black Metal (Bathory) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-bathory
    set -U base16_fish_theme black-metal-bathory
