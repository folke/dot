...
function base16-material-palenight -d "base16 Material Palenight theme"
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pj 32374d # selection color
    ...
    set -U base16_fish_theme material-palenight
