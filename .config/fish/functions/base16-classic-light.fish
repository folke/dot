...
function base16-classic-light -d "base16 Classic Light theme"
    ...
    set color_foreground "30/30/30" # Base 05
    set color_background "f5/f5/f5" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg 303030 # foreground
      __put_template_custom Ph f5f5f5 # background
      __put_template_custom Pi 303030 # bold color
      __put_template_custom Pj d0d0d0 # selection color
      __put_template_custom Pk 303030 # selected text color
      __put_template_custom Pl 303030 # cursor
      __put_template_custom Pm f5f5f5 # cursor text
    ...
    set -gx fish_pager_color_description "d28445" yellow

    __base16_fish_shell_set_background "f5" "f5" "f5"
    __base16_fish_shell_create_vimrc_background classic-light
    set -U base16_fish_theme classic-light
