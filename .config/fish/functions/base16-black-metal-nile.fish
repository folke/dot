...
function base16-black-metal-nile -d "base16 Black Metal (Nile) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-nile
    set -U base16_fish_theme black-metal-nile
