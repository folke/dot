...
function base16-xcode-dusk -d "base16 XCode Dusk theme"
    ...
    set color_foreground "93/95/99" # Base 05
    set color_background "28/2b/35" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg 939599 # foreground
      __put_template_custom Ph 282b35 # background
      __put_template_custom Pi 939599 # bold color
      __put_template_custom Pj 53555d # selection color
      __put_template_custom Pk 939599 # selected text color
      __put_template_custom Pl 939599 # cursor
      __put_template_custom Pm 282b35 # cursor text
    ...
    set -gx fish_color_autosuggestion "686a71" brblack
    set -gx fish_pager_color_description "786dc5" yellow

    __base16_fish_shell_set_background "28" "2b" "35"
    __base16_fish_shell_create_vimrc_background xcode-dusk
    set -U base16_fish_theme xcode-dusk
