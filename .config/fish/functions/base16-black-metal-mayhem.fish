...
function base16-black-metal-mayhem -d "base16 Black Metal (Mayhem) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-mayhem
    set -U base16_fish_theme black-metal-mayhem
