...
function base16-default-light -d "base16 Default Light theme"
    ...
    __base16_fish_shell_create_vimrc_background default-light
    set -U base16_fish_theme default-light
