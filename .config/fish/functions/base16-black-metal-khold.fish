...
function base16-black-metal-khold -d "base16 Black Metal (Khold) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-khold
    set -U base16_fish_theme black-metal-khold
