...
function base16-black-metal-dark-funeral -d "base16 Black Metal (Dark Funeral) theme"
    ...
    __base16_fish_shell_create_vimrc_background black-metal-dark-funeral
    set -U base16_fish_theme black-metal-dark-funeral
