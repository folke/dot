...
function base16-solarized-light -d "base16 Solarized Light theme"
    ...
    set color_foreground "58/6e/75" # Base 05
    set color_background "fd/f6/e3" # Base 00
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg 586e75 # foreground
      __put_template_custom Ph fdf6e3 # background
      __put_template_custom Pi 586e75 # bold color
      __put_template_custom Pj 93a1a1 # selection color
      __put_template_custom Pk 586e75 # selected text color
      __put_template_custom Pl 586e75 # cursor
      __put_template_custom Pm fdf6e3 # cursor text
    ...
    set -gx fish_color_autosuggestion "839496" brblack
    set -gx fish_pager_color_description "cb4b16" yellow

    __base16_fish_shell_set_background "fd" "f6" "e3"
    __base16_fish_shell_create_vimrc_background solarized-light
    set -U base16_fish_theme solarized-light
