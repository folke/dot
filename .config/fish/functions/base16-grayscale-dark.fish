...
function base16-grayscale-dark -d "base16 Grayscale Dark theme"
    ...
    set color_foreground "b9/b9/b9" # Base 05
    ...
    if test -n "$ITERM_SESSION_ID"
      ...
      __put_template_custom Pg b9b9b9 # foreground
      __put_template_custom Ph 101010 # background
      __put_template_custom Pi b9b9b9 # bold color
      __put_template_custom Pj 464646 # selection color
      __put_template_custom Pk b9b9b9 # selected text color
      __put_template_custom Pl b9b9b9 # cursor
    ...
    __base16_fish_shell_create_vimrc_background grayscale-dark
    set -U base16_fish_theme grayscale-dark
