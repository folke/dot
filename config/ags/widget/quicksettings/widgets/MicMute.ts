...
const icon = () =>
  microphone.is_muted || microphone.stream?.is_muted ? icons.audio.mic.muted : icons.audio.mic.high

const label = () => (microphone.is_muted || microphone.stream?.is_muted ? "Muted" : "Unmuted")
