...
local function set_wallpaper(s)
  beautiful.wallpaper = "/home/folke/Pictures/bali-boat.jpg"
  -- Wallpaper
...
local globalkeys = gears.table.join(
  ...
  awful.key({ modkey, "Control" }, "Down", awful.tag.viewnext, { description = "view next", group = "tag" }),
